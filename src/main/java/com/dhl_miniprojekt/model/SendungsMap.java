...
//    private List<Sendung> sendungsliste;
    ...
    public HashMap erstelleSendungsListe() {
        ...
        Sendung sendung1 = new Sendung("1",StandardversandEnum.STANDARD, adresse1, adresse2, LieferstatusEnum.AUFGEGEBEN, LocalDateTime.now().minusDays(2), LocalDateTime.now().plusDays(1));
        Sendung sendung2 = new Sendung("2", StandardversandEnum.STANDARD, adresse2, adresse1, LieferstatusEnum.IN_ZUSTELLUNG, LocalDateTime.now().minusDays(2), LocalDateTime.now().plusDays(1));
        Sendung sendung3 = new Sendung("3", StandardversandEnum.EXPRESS, adresse3, adresse4, LieferstatusEnum.ZUGESTELLT, LocalDateTime.now().minusDays(10), LocalDateTime.now().minusDays(1));
        Sendung sendung4 = new Sendung("4", StandardversandEnum.STANDARD, adresse4, adresse5, LieferstatusEnum.AUFGEGEBEN, LocalDateTime.now().minusDays(1), LocalDateTime.now().plusDays(4));
        Sendung sendung5 = new Sendung("5", StandardversandEnum.EXPRESS, adresse5, adresse4, LieferstatusEnum.ZUGESTELLT, LocalDateTime.now().minusDays(50), LocalDateTime.now().minusDays(20));
